...
echo && echo -e " TCP加速 一键安装管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
 ...
 ${Green_font_prefix}2.${Font_color_suffix} 切换到不卸载内核版本	
 ${Green_font_prefix}3.${Font_color_suffix} 切换到一键DD系统脚本
 ${Green_font_prefix}4.${Font_color_suffix} 安装 BBR原版内核
 ${Green_font_prefix}5.${Font_color_suffix} 安装 BBRplus版内核
 ${Green_font_prefix}6.${Font_color_suffix} 安装 Lotserver(锐速)内核		
 ${Green_font_prefix}7.${Font_color_suffix} 安装 cloud内核 KVM
 ${Green_font_prefix}8.${Font_color_suffix} 安装 BBRplus新版内核
 ${Green_font_prefix}9.${Font_color_suffix} 安装 xanmod版内核
 ${Green_font_prefix}10.${Font_color_suffix} 使用BBR+FQ加速		
 ${Green_font_prefix}11.${Font_color_suffix} 使用BBR+FQ_PIE加速 
 ${Green_font_prefix}12.${Font_color_suffix} 使用BBR+CAKE加速
 ${Green_font_prefix}13.${Font_color_suffix} 使用BBR2+FQ加速	 	
 ${Green_font_prefix}14.${Font_color_suffix} 使用BBR2+FQ_PIE加速 
 ${Green_font_prefix}15.${Font_color_suffix} 使用BBR2+CAKE加速
 ${Green_font_prefix}16.${Font_color_suffix} 开启ECN	 		
 ${Green_font_prefix}17.${Font_color_suffix} 关闭ECN
 ${Green_font_prefix}18.${Font_color_suffix} 使用BBRplus+FQ版加速 
 ${Green_font_prefix}19.${Font_color_suffix} 使用Lotserver(锐速)加速 
 ${Green_font_prefix}20.${Font_color_suffix} 系统配置优化	 	
 ${Green_font_prefix}21.${Font_color_suffix} 应用johnrosen1的优化方案
 ${Green_font_prefix}22.${Font_color_suffix} 禁用IPv6	 		
 ${Green_font_prefix}23.${Font_color_suffix} 开启IPv6  
 ${Green_font_prefix}24.${Font_color_suffix} 卸载全部加速	 	
